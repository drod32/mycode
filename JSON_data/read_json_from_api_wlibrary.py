...
def main():
    ...
    json_data = response.json()   # all requests objects, have a .json() method
    ...
    print(json_data)              # we should now see the data from the file
    print(type(json_data))        # the data type should be 'dict' NOT 'str'
    print(json_data.get('id'))    # perform a test lookup on a 'dict' data type
